...
const MenuIcon: FunctionComponent<Props> = ({ icon }) => {
  return (
    <div class={styles.menuIcon} dangerouslySetInnerHTML={{ __html: icon }} />
  );
};
